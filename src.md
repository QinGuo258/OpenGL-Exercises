...
| **tuning.json 热重载** | 110+ 可调参数控制光照、阴影、SSAO、点光源、雾、云、风、后处理、SSR、摄像机、玩家物理、战斗；启动加载 + F1 热重载 |
| **UI 绘制** | 准星、血条心形、快捷栏（9 格）、物品图标、聊天记录（T 键）、F3 调试覆盖层。**F8 一键隐藏 HUD**（快捷栏/血条/准星 + 第一人称手臂/手持物），聊天/调试面板/菜单不受影响 |
